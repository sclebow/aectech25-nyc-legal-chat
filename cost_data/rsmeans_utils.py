...
def find_by_description(description, confidence_threshold=0.5):
    """
    ...
    # 4. Build section list and proceed as before (NO CHUNKING)
    ...
    def llm_section_query(section_list):
        system_prompt = (
    ...
    import re
    code_confidence = {}
    selected_codes_str = llm_section_query(section_list)
